...
function OldChallenge({params}: { params: { id: string } }) {
    ...
    const ephemeralLaunchButton = () => {
        ...
        let buttonText = project !== null && project["has_access"] !== null && !project["has_access"] ? "Buy Content" : "Launch"
        let toolTipText = "Unknown Launch Time"
