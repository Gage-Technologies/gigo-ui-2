...
function AccountSettings() {
    ...
    const deleteUserAccount = async () => {
        ...
        // persistStore(makeStore(), persistOptions).purge()
                                        ...
                                        <CardContent>
                                            ...
                                            <List>
                                                {(!inTrial || hasPaymentInfo) && !alreadyCancelled && (
                                                    <ListItem>
                                                        <ListItemText
                                                            primary={`${membershipCost === "80.00" ? "Yearly" : "Monthly"} Payment`}
    ...
    const avatarTab = () => {
        return (
            // @ts-ignore
            <Box sx={{ margin: 3, padding: 3, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", backgroundColor: theme.palette.background.avatar, borderRadius: "30px" }}>
            ...
            <CssBaseline>
                ...
                <Box
                    sx={{
                        ...
                        justifyContent: 'center',
                        // alignItems: 'center',
                        height: 'calc(100vh - 80px)', // Use the full height of the viewport
                        outlineColor: 'black',
                        borderRadius: 1,
                    }}
                >
                    <Grid container sx={{
                        ...
                        <Grid item xs={2}>
                            ...
                            >
                                {tabValues.map((minorValue, index) => {
                                    return <Tab key={index} label={minorValue} value={minorValue}
