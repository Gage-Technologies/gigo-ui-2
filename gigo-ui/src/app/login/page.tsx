...
function Login() {
            ...
            <Box sx={{
                ...
                <Grid container justifyContent="center">
                    ...
                    >
                        ...
                        <Button
                            onClick={async () => {
                                navigate.push("/signup?forward=" + encodeURIComponent(forwardPath || ""))
                            }}
                            variant={`text`}
                            color={"primary"}
                            sx={{
    ...
    const renderLanding = () => {
        ...
        if (aspectRatio === "21:9") {
            if (holiday === "Christmas") {
                return "christmas-login-21-9.png"
            }
            return "login_background-21-9.jpg"
        } else {
            if (holiday === "Christmas") {
                return "christmas-login.png"
            }
    ...
    return (
        <div
            style={{
                backgroundColor: `${theme.palette.background.default}`,
                backgroundImage: `url(${config.rootPath + "/cloudstore/images/" + renderLanding()})`,
