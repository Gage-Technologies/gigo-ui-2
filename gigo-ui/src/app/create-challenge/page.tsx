...
function CreateProject() {
    ...
    React.useEffect(() => {
        const storedConfig = localStorage.getItem('workspace_config');
        if (storedConfig) {
            const parsedConfig = JSON.parse(storedConfig) as WorkspaceConfig;
    ...
    const launchWorkspace = async () => {
        ...
        navigate.push(`/launchpad/${workspace._id}`)
    }
                ...
                >
                    <div style={{
                        ...
                        <div style={{
                            ...
                            categories: Interactive, Playground, Casual, Debug and Competitive. Each category has its
                            own set
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <div style={{
                                    ...
                                    Debug Challenges will help sharpen your debugging skills. These projects are
                                    designed
                                    similar to casual, with most of the code being done, but with bugs sprinkled in.
                                    Strengthen your ability to track back and find bugs. Learn how to test the most
                                    important tool in a developer&#39;s arsenal.
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                >
                    <div style={{
                        ...
                        <div style={{
                            ...
                            When creating a casual challenge or a debug challenge that others can attempt, you must
                            create a rubric
                            for what it takes to have a complete attempt. For a casual challenge this is an explanation
                            of the goals of the
                            project and what the code must be able to successfully complete, in order for an attempt to
                            be considered successful. For a debug challenge it is a general explanation of the bug to
                            look out for or where the function is at right now and where it needs to go to. If you do
                            not input an evaluation, a default evaluation will be
                            used.
                        </div>
                    </div>
                </Popover>
                ...
                <Grid container style={{
                    ...
                    {/* <Grid item xs={12}>
                        <div style={{
                            ...
                            <Switch value={visibility} checked={visibility}
                                    disabled={status.toString() !== "1" || premium === "0"}
                                    onClick={() => {
                                        if (premium !== "0") {
                                            let updateState = Object.assign({}, initialCreateProjectStateUpdate);
                                        ...
                                        {option.title !== "Default" && option.title !== "Custom" && (
                                            <Grid item container xs="auto" alignItems="center">
                                                ...
                                                <Typography align="right"
                                                            style={{marginLeft: 4}}>{option.uses}</Typography>
                                                <Tooltip title={"Completions"} style={{marginLeft: 8}}>
                                                    <CheckIcon/>
                                                </Tooltip>
                                                <Typography align="right"
                                                            style={{marginLeft: 4}}>{option.completions}</Typography>
                                            </Grid>
                                        )}
                                    </Grid>
                                </li>
                            ...
                            content: (
                                <div>
                                    ...
                                    <p style={styles.tutorialText}>Challenges are how lessons and projects are
                                        structured on GIGO. Finish the tutorial to learn how to create a Challenge on
                                        GIGO.</p>
                                </div>
                            ),
                        },
                        {
                            content: (
                                <div>
                                    ...
                                    <p style={styles.tutorialText}>Images are required for Challenges on GIGO. We
                                        encourage you to upload your own but if you need an image, use the `Generate
                                        Image` button to create one.</p>
                                </div>
                            ),
                            moreInfo: (
                                <div>
                        ...
                        },
                        {
                            content: (
                                <div>
                                    ...
                                    <p style={styles.tutorialText}>GIGO uses Workspace Configs to launch Challenge
                                        environments. Workspace Configs create reproducible and consistent
                                        environments.</p>
                                </div>
                            ),
                            moreInfo: (
                                <div>
                                    <p style={styles.tutorialText}>Workspace Configs allow virtually infinite
                                        configurations for Challenges. You can even configure a full Docker Compose
                                        configuration to launch containers inside the workspace. Here&#39;s some pro
                                        tips:</p>
                                    <ul>
                                        <li style={styles.tutorialText}>Use containers via the `containers` key instead
                                            of installing programs with the `exec` key. Containers can be cached and
                                            usually provide faster launches.
                                        </li>
                                        <li style={styles.tutorialText}>Consider creating a custom container from the
                                            `gigodev/gimg:ubuntu-base` container if you find yourself repeating
                                            configurations.
                                        </li>
                                        <li style={styles.tutorialText}>Only content in the `/home/gigo` directory
                                            persists between restarts. Try to keep your content that you want to persist
                                            in that folder.
                                        </li>
                                        <li style={styles.tutorialText}>Workspaces are ephemeral by nature and only
                                            persist for a maximum of 24h of inactivity.
                                        </li>
                                    </ul>
                                </div>
                            )
