                                ...
                                <div style={{display: "flex", justifyContent: "center", width: "50%", alignItems: "center", flexDirection: "column"}}>
                                    ...
                                    <Grid item xs={"auto"}>
                                        <Autocomplete
                                            ...
                                            options={programmingLanguages.map((_: any, i: any) => i)}
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                                        ...
                                        <div style={{position: "absolute", bottom: "15%"}}>
                                            <Button variant={"outlined"} onClick={() => {
                                                localStorage.setItem('workspace_config', JSON.stringify(revisionObject));
                                                navigate.push('/create-challenge');
                                            }}>Create Project With config</Button>
                                        </div>
                                    </div>
                                </div>
                            </div>
