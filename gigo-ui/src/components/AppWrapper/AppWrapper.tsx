...
//                     'Content-Type': 'application/json'
//                 },
//                 body: JSON.stringify(config.rootPath)
//             },
//         );
//
//         if (res && res["token"]) {
...
//         const forwardPath = encodeURIComponent(window.location.pathname);
//         clearReducers()
//
//         let res = await call(
//             "/api/auth/logout",
...
//                 navigate("/login?forward="+forwardPath)
//             }
//
...
//             window.location.pathname.startsWith('/byte')
//         )) {
//             return null;
//         }
//
