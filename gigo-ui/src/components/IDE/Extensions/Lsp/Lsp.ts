...
class LanguageServerPlugin implements PluginValue {
    ...
    async requestCompletion(context: CompletionContext, {line, character}: { line: number; character: number }, {
        ...
        console.log("requestCompletion1: ", context)

        if (!this.client.ready || !this.client.capabilities!.completionProvider) return null;

        console.log("requestCompletion2: ", context)

        this.sendChange({
            documentText: context.state.doc.toString(),
        });

        console.log("requestCompletion3: ", context)
        ...
        console.log("requestCompletion4: ", result)

        if (!result) return null;

        console.log("requestCompletion5: ", result)

        const items = 'items' in result ? result.items : result;

        console.log("requestCompletion6: ", items)
        ...
        console.log("requestCompletion7: ", options)
        ...
        console.log("requestCompletion8: ", options)
        ...
        console.log("requestCompletion9: ", options)
