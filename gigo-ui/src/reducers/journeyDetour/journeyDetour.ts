...
export const selectJourneyDetourState = (state: RootState) => state.journeyDetour ? state.journeyDetour : initialJourneyDetourState;
export const selectJourneysId = (state: RootState) => state.journeyDetour ? state.journeyDetour.id : initialJourneyDetourState.id;
