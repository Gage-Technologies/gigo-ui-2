...
export const authSlice = createSlice({
    ...
    reducers: {
        updateAuthState: (state: any, update: PayloadAction<AuthStateUpdate>) => {
...
export const selectAuthStateAuth = (state: RootState) => state.auth && state.auth.authenticated ? state.auth.authenticated : initialAuthState.authenticated;
export const selectAuthStateToken = (state: RootState) => state.auth && state.auth.token ? state.auth.token : initialAuthState.token;
export const selectAuthStateId = (state: RootState) => state.auth && state.auth.id ? state.auth.id : initialAuthState.id;
export const selectAuthStateRole = (state: RootState) => state.auth && state.auth.role ? state.auth.role : initialAuthState.role;
export const selectAuthStateTier = (state: RootState) => state.auth && state.auth.tier ? state.auth.tier : initialAuthState.tier;
export const selectAuthStateRank = (state: RootState) => state.auth && state.auth.rank ? state.auth.rank : initialAuthState.rank;
export const selectAuthStateCoffee = (state: RootState) => state.auth && state.auth.coffee ? state.auth.coffee : initialAuthState.coffee;
export const selectAuthStateExpiration = (state: RootState) => state.auth && state.auth.expiration ? state.auth.expiration : initialAuthState.expiration;
export const selectAuthStateUserName = (state: RootState) => state.auth && state.auth.userName ? state.auth.userName : initialAuthState.userName;
export const selectAuthStateEmail = (state: RootState) => state.auth && state.auth.email ? state.auth.email : initialAuthState.email;
export const selectAuthStatePhone = (state: RootState) => state.auth && state.auth.phone ? state.auth.phone : initialAuthState.phone;
export const selectAuthStateThumbnail = (state: RootState) => state.auth && state.auth.thumbnail ? state.auth.thumbnail : initialAuthState.thumbnail;
export const selectAuthStateColorPalette = (state: RootState) => state.auth && state.auth.backgroundColor ? state.auth.backgroundColor : initialAuthState.backgroundColor;
export const selectAuthStateRenderInFront = (state: RootState) => state.auth && state.auth.backgroundRenderInFront ? state.auth.backgroundRenderInFront : initialAuthState.backgroundRenderInFront;
export const selectAuthStateBackgroundName = (state: RootState) => state.auth && state.auth.backgroundName ? state.auth.backgroundName : initialAuthState.backgroundName;
export const selectAuthStateExclusiveContent = (state: RootState) => state.auth && state.auth.exclusiveContent ? state.auth.exclusiveContent : initialAuthState.exclusiveContent;
export const selectAuthStateExclusiveAgreement = (state: RootState) => state.auth && state.auth.exclusiveAgreement ? state.auth.exclusiveAgreement : initialAuthState.exclusiveAgreement;
export const selectAuthStateTutorialState = (state: RootState) => state.auth && state.auth.tutorialState ? state.auth.tutorialState : initialAuthState.tutorialState;
export const selectAuthStateInTrial = (state: RootState) => state.auth && state.auth.inTrial? state.auth.inTrial : initialAuthState.inTrial;
export const selectAuthStateHasSubscription = (state: RootState) => state.auth && state.auth.hasSubscription? state.auth.hasSubscription : initialAuthState.hasSubscription;
export const selectAuthStateHasPaymentInfo = (state: RootState) => state.auth && state.auth.hasPaymentInfo? state.auth.hasPaymentInfo : initialAuthState.hasPaymentInfo;
